		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reporte KCC Costo de Distribucion ",
									"targetURL": "#uikccdistcost-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uikccdistcost-display": {
								"semanticObject": "uikccdistcost",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uikccdistcost",
									"url": sap.ui.require.toUrl("uikccdistcost")
								}
							}
						}
					}
